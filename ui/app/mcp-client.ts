...
export async function getClaudeRecommendations(
  ...
  const userMessage = [
    ...
    ...(isAgentic ? [
      ...
      `- Filter by name: entityName(dt.entity.service) == "my-service" — NEVER dt.entity.service == "my-service"`,
      `- Display names: serviceName = entityName(dt.entity.service) in by:{} or fieldsAdd`,
